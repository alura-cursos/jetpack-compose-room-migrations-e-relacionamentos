...
interface ContatoDao {
    ...
    @Query("SELECT * FROM Contato WHERE idUsuario = :usuarioAtual AND nome LIKE :valorBusca||'%'")
    fun buscaTodosPorUsuarioEPorValor(usuarioAtual: String, valorBusca: String):
            Flow<List<Contato>>
}